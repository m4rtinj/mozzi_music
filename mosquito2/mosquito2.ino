...
int OSC_TWO_OFFSET = 5;       // amount to offset the second midi note from the osc one's midi note (5 is a fifth, two is a second, etc)
...
void updateControl(){
  ...
  float oscTwo_offset = 5; //((oscTwo_val * DIV1023) * DIV10) * OSC_TWO_OFFSET;                // frequency offset for second oscillator +/- 0.2 oscOne freq
